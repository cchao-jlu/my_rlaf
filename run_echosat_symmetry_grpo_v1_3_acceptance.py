...
RUN_DIR = ROOT / "runs/GNN_Glucose_3SAT_EchoSAT_SymmetryGRPO_v1_3_WC1_Continuation"
PREFIX = "echosat_symmetry_grpo_v1_3_acceptance"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run v1.3 targeted checkpoint acceptance without training.")
...
def main() -> None:
    ...
    summary_command = [
        ...
        *selected,
        "--out-observations",
        str(ROOT / "runs/analysis/echosat_symmetry_grpo_v1_3_acceptance_observations.csv"),
        "--out-family",
        str(ROOT / "runs/analysis/echosat_symmetry_grpo_v1_3_acceptance_summary_by_family.csv"),
        "--out-base",
        str(ROOT / "runs/analysis/echosat_symmetry_grpo_v1_3_acceptance_summary_by_base.csv"),
        "--out-strict",
        str(ROOT / "runs/analysis/echosat_symmetry_grpo_v1_3_acceptance_strict_acceptance.csv"),
        "--doc",
        str(ROOT / "docs/echosat_symmetry_grpo_v1_3_acceptance.md"),
        "--title",
        "EchoSAT Symmetry GRPO v1.3 Targeted Acceptance",
        "--description",
        (
            "This is a targeted checkpoint acceptance audit for the v1.3 WC1 continuation run. "
