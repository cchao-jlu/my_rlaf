...
Fixed schedule: march:0.1s, cadical_seed1:0.1s, cadical_plain_seed1:0.1s, cadical_shuffle_seed1:0.1s.
Schedule source: `command_line`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3sat | 410 | 3sat_12.cnf | 4 | 0.400 | 0.400 | 5.117 | False | -1 |  |

Artifacts:

```text
runs/analysis/tmp_non_neural_variant_smoke/attempts/
runs/analysis/tmp_non_neural_variant_smoke/raw_attempts.csv
runs/analysis/tmp_non_neural_variant_smoke/instance_summary.csv
runs/analysis/tmp_non_neural_variant_smoke/schedule.csv
```
