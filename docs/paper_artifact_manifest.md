...
| March strong-baseline audit | `runs/march/solver_stats_full400_cpu60.csv`; `runs/analysis/march_full400_cpu60/strict60_summary.csv`; `runs/analysis/march_full400_cpu60/neural_vs_march_overlap.csv`; `docs/march_full400_baseline_audit.md` | `run_external_solver_baseline.py`; `audit_march_full400_baseline.py` | Yes | CNF dataset only for rerun |
