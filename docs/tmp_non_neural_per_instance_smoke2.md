...
Schedule source: `runs/analysis/tmp_non_neural_per_instance_smoke2/source_schedule.csv`.
Budget source: `runs/analysis/tmp_non_neural_per_instance_smoke2/synthetic_neural_summary.csv per_instance_total_cpu_allocated`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 3sat | 410 | 3sat_12.cnf | 2 | 0.200 | 0.200 | 5.112 | False | -1 |  |

Artifacts:

```text
runs/analysis/tmp_non_neural_per_instance_smoke2/run/attempts/
runs/analysis/tmp_non_neural_per_instance_smoke2/run/raw_attempts.csv
runs/analysis/tmp_non_neural_per_instance_smoke2/run/instance_summary.csv
runs/analysis/tmp_non_neural_per_instance_smoke2/run/schedule.csv
```
