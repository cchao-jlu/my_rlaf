...
| instances | neural_summary | aggregation | neural_budget_min | neural_budget_mean | neural_budget_max | selected_budget | schedule |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | runs/analysis/tmp_residual_audit_smoke/neural_selector_dev_seed1729/expanded_early_trace_summary.csv | mean | 496.000 | 496.000 | 496.000 | 496.000 | march:60,cadical:60,march:60,cadical:60,march:60,cadical:60,march:60,cadical:60,march:16 |
