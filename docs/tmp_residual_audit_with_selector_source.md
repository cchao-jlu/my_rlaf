...
| heldout_non_neural_exists | pass | runs/analysis/tmp_non_neural_control_schedule_csv/instance_summary.csv |
...
| heldout_neural_reports_allocated_budget | pass | neural summary should include total_cpu_allocated for same-budget controls |
| heldout_neural_reports_full_allocated_budget | pass | neural summary should include full_cpu_allocated |
...
| non_neural_schedule_exists | pass | runs/analysis/tmp_residual_audit_smoke/non_neural_schedule_from_dev.csv |
...
| non_neural_run_schedule_source_exists | pass | runs/analysis/tmp_non_neural_control_schedule_csv/schedule.csv |
| non_neural_run_schedule_source_matches | pass | expected=runs/analysis/tmp_residual_audit_smoke/non_neural_schedule_from_dev.csv observed=['runs/analysis/tmp_residual_audit_smoke/non_neural_schedule_from_dev.csv'] |
