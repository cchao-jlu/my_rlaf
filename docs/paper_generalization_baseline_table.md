...
| CaDiCaL default full400 | new run | top-conference baseline audit needed a stronger unguided CDCL reference than Glucose default | `runs/cadical/solver_stats_full400_cpu60.csv` |
...
| 400 | CaDiCaL default | single_run | 75 | 42.924 | 60.000 | `runs/cadical/solver_stats_full400_cpu60.csv` |
