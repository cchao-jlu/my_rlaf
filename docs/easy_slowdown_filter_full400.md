...
- 输出 checkpoint：`runs/GNN_Glucose_3SAT_TwoStageRiskControllerCompactRiskEvidence300350400_EasySlowdownFilter`
- threshold mode：`train_conservative`
- threshold：`0.276170`
- bias：`-0.290794`
...
| mean_delta_post_warmup_est_vs_base   | -1.416427  |
...
| 3sat_82.cnf  | medium(10-30s)    | slower_both_solved | 14.616988  | 0.779136  | 0.745158      | 0.275569      | 0             |
