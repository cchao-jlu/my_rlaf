...
Table~\ref{tab:generalization-baseline} reports the broader generalization and baseline robustness check. The 300/350 rows are single-run appendix checks under the frozen protocol. The 400 neural rows are the main 3-seed solver robustness results. Local Boundary Correction is only evaluated on the 400-boundary setting.
