...
\begin{enumerate}
    ...
    \item We audit an end-to-end neural-first/CDCL-second portfolio against repeated CaDiCaL baselines, showing boundary-sensitive complementarity without claiming robust solved-count dominance.
\end{enumerate}
