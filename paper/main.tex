...
The March baseline further limits the claim. Under the strict 60s count, March solves 184/200 instances with mean capped time 26.702s. It solves \texttt{3sat\_140.cnf}, \texttt{3sat\_147.cnf}, and \texttt{3sat\_188.cnf}, removing the CaDiCaL-strict complement set. Local Boundary Correction has no solved-count complement against this March run. We therefore treat the neural results as evidence about risk-controlled feedback inside a neural-guided Glucose workflow, not as a strong-SAT-baseline performance result.
